...
namespace PersonalJournal.Controllers
{
    public class EntriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EntryId,Mood,Entries,UserId,DateCreated")] Entry entry)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("EntryId,Mood,Entries,UserId,DateCreated")] Entry entry)
        {
            if (id != entry.EntryId)
            {
                return NotFound();
